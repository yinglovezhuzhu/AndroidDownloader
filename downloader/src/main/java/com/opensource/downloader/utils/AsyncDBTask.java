 ...
 * perform background sqlite database operations and publish results on the UI thread without
 * having to manipulate threads and/or handlers, and it can avoid fc what caused by database operation in multiple thread.</p>
 *
 ...
 *
 * <h2>Usage</h2>
 * <p>AsyncDBTask must be subclassed to be used. The subclass will override at least
 ...
 * </pre>
 *
 * <h2>AsyncDBTask generic types</h2>
...
public abstract class AsyncDBTask<Params, Progress, Result> {
    private static final String LOG_TAG = "AsyncDBTask";

    /**
     * CORE_POOL_SIZE must be valued 1, That can prevent more than one thread execute at the same time, what is the reason
     * lead application force close by sqlite database operation. 
     */
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "AsyncDBTask #" + mCount.getAndIncrement());
        }
    };
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new AsyncTaskExResult<Result>(AsyncDBTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new AsyncTaskExResult<Result>(AsyncDBTask.this, result));
                message.sendToTarget();
            }
        };
    }
